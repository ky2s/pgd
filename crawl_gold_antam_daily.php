...
$temp_buy_price = removeCommasAndConvertToInt($strprice['buy_val']);
$temp_sell_price = removeCommasAndConvertToInt($strprice['sell_val']);

// penyesuaian harga Antam
// $price = $temp_price - 30000;
$price = $temp_buy_price;
// checking value
$result = getDaily();
...
// INSERT NEW DATA ---------------------------------------------------------------------------------------
if($price >= 1){
    $result = insertGold("Emas Antam", 1, $price, $temp_sell_price);
}
